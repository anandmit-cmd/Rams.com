...
import { Bell, LayoutGrid, LogOut, Siren, List } from 'lucide-react';
import placeholderImages from '@/lib/placeholder-images.json';
import { auth } from '@/lib/firebase';


const menuItems = [
    { href: '/dashboard/ambulance', label: 'Dashboard', icon: LayoutGrid },
    { href: '#', label: 'Active Alerts', icon: Siren },
    { href: '/dashboard/ambulance/trip-history', label: 'Trip History', icon: List },
];

export default function AmbulanceDashboardLayout({
  children,
}: {
