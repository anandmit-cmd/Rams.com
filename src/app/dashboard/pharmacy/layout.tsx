...
import { Bell, ShoppingCart, Package, BarChart, LogOut, LayoutGrid } from 'lucide-react';
import placeholderImages from '@/lib/placeholder-images.json';
import { auth } from '@/lib/firebase';


const menuItems = [
    { href: '/dashboard/pharmacy', label: 'Dashboard', icon: LayoutGrid },
    { href: '#', label: 'Orders', icon: ShoppingCart },
    { href: '/dashboard/pharmacy/inventory', label: 'Inventory', icon: Package },
